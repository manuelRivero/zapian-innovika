...
const defaultLogos: PartnerLogo[] = [
  ...
  {
    id: "espacios",
    src: "/images/logos-07.svg",
    alt: "Espacios by Innovika",
    width: 90,
    height: 90,
  },
]
